 ...
 * now (see data/extract, data/local), and update checks talk directly to a public
 * GitHub repo instead (see UpdateRepository). This interface only keeps what
 * still talks to the real backend — login (for the silent service account, see
 * MusicAgentApp / ServiceAccountAuthenticator) and analytics events. */
